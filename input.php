                ...
                <div class="bg-white p-4 rounded-lg shadow">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-gray-600"><?= htmlspecialchars($row['Alamat']) ?>
                                , <?= htmlspecialchars($row['Kode_Pos']) ?></p>
                        ...
                        <div class="flex space-x-2">
                            <a href="edit.php?id=<?= $row['id'] ?>&role=<?= $row['role'] ?>&dataid=<?= $dataid ?>"
                               class="text-gray-500 hover:text-gray-700"><i class="fas fa-edit"></i></a>
                            <a href="?delete_id=<?= $row['id'] ?>&role=<?= $row['role'] ?>&dataid=<?= $dataid ?>"
