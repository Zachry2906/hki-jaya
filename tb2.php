        ...
        <form>
            <div class="grid grid-cols-1 gap-4">
                <div class="flex items-center">
                    ...
                    <input type="text" name="alamat" placeholder="Masukan Alamat lengkap Pencipta"
                ...
                <br>
                <div class="flex items-center">
                    <label name="pemegang_hakcipta" class="w-1/4 text-gray-700">Apakah data pencipta diatas merupakan
                        data pemegang hakcipta ?</label>
